...
export default function BuyWarningModal(props) {
    const modalClose = () => {
        props.setBuyWarningModal(false);
    }
    return (
        ...
        <div className="flex flex-wrap items-center justify-center w-full  max-w-lg p-5 relative mx-auto my-auto rounded-xl shadow-lg bg-white ring-4 ring-red-600 ">
          ...
          <label className="text-2xl font-bold text-red-600">YOU DONT ANY ITEMS ON YOUR CART GO BUY SOMETHING FIRST</label>
          </div>

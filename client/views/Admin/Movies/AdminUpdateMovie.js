                  ...
                  <div className="text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className=" flex items-center justify-center min-w-screen">                    
                        <div className="flex flex-col w-full ml-3 mt-5">
                            ...
                            <div className="mb-5 mt-1"><select className="rounded-lg  w-48 border-blue-500 text-sm" type="text" name="movie_release_status" onChange={handleChange('movie_release')} disabled={edit ? false : true}>

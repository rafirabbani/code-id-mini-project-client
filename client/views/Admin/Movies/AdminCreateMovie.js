                  ...
                  <div className="text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className=" flex items-center justify-center min-w-screen">                    
                        <div className="flex flex-col w-full ml-3 mt-5">
                            ...
                            <div className="mb-5 mt-1"><input className="rounded-lg w-48 border-blue-500 text-sm" type="text" name="movie_title" onChange={handleChange('movie_title')}/></div>
                            <div className=""><label className="text-l text-gray-600 focus:outline-none ring-0 border-transparent">Movie Episode</label></div>
                            <div className="mb-5 mt-1"><input className="rounded-lg w-48 border-blue-500 text-sm" type="text" name="movie_episode" onChange={handleChange('movie_episode')}/></div>
                            <div className=""><label className="text-l text-gray-600 focus:outline-none ring-0 border-transparent">Movie Director</label></div>
                            <div className="mb-5 mt-1"><input className="rounded-lg w-48 border-blue-500 text-sm" type="text" name="movie_director" onChange={handleChange('movie_director')}/></div>
                            <div className=""><label className="text-l text-gray-600 focus:outline-none ring-0 border-transparent">Movie Studio</label></div>
                            <div className="mb-5 mt-1"><input className="rounded-lg  w-48 border-blue-500 text-sm" type="text" name="movie_studio" onChange={handleChange('movie_studio')}/></div>
                            ...
                            <div className="mb-5 mt-1"><select className="rounded-lg w-48 border-blue-500 text-sm" type="text" name="movie_tv_status" onChange={handleChange('movie_tv_status')}>
                                <option defaultValue hidden>Movie TV Status</option>
                            ...
                            <div className="mb-5 mt-1"><input className="rounded-lg  w-48 border-blue-500 text-xs" type="text" name="movie_country" onChange={handleChange('movie_country')}/></div>
                            <div className=""><label className="text-l text-gray-600 focus:outline-none ring-0 border-transparent">Movie Genre</label></div>
                            <input className="rounded-lg mb-5 mt-1 w-48 border-blue-500 text-sm" type="text" name="movie_genre" onChange={handleChange('movie_genre')}/>
                            <div className=""><label className="text-l text-gray-600 focus:outline-none ring-0 border-transparent">Movie Rating</label></div>
                            <input className="rounded-lg mb-5 mt-1 w-48 border-blue-500 text-sm" type="number" name="movie_rating" onChange={handleChange('movie_rating')}/>
                            <div className=""><label className="text-l text-gray-600 focus:outline-none ring-0 border-transparent">Movie Network</label></div>
                            <input className="rounded-lg mb-5 mt-1 w-48 border-blue-500 text-sm" type="text" name="movie_network" onChange={handleChange('movie_network')}/>
                            <div className=""><label className="text-l text-gray-600 focus:outline-none ring-0 border-transparent">Movie Trailer</label></div>
                            <input className="rounded-lg mb-5 mt-1 w-48 border-blue-500 text-sm" type="text" name="movie_trailer" onChange={handleChange('movie_trailer')}/>
                            <div className=""><label className="text-l text-gray-600 focus:outline-none ring-0 border-transparent">Total Views</label></div>
                            <input className="rounded-lg mb-5 mt-1 w-48 border-blue-500 text-sm" type="number" name="movie_views" onChange={handleChange('movie_views')}/>
                            <div className=""><label className="text-l text-gray-600 focus:outline-none ring-0 border-transparent">Movie Price</label></div>
                            <input className="rounded-lg mb-5 mt-1 w-48 border-blue-500 text-sm" type="number" name="movie_price" onChange={handleChange('movie_price')}/>  
